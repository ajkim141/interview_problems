...
- [Given two words, print the steps in turning one word into the other, or a message that it is not possible.](http://nbviewer.ipython.org/github/ajkim141/interview_problems/blob/master/transmute.ipynb)
